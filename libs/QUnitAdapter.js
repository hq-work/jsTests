...
(function() {
				...
				window.stop = function() {
					var capturedAssertions = [],
			    		...
			    		assertions = ['ok', 'equal', 'notEqual', 'deepEqual', 'notDeepEqual',
			    		              'strictEqual', 'notStrictEqual', 'raises', 'throws'];
					...
					window.throws = function() { capturedAssertions.push(['throws', arguments]) };
	...
	window.throws = function(block, expected, message) {
		window.raises(block, expected, message);
	};
