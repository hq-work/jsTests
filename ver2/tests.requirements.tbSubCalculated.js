if (typeof (UnitTestsApplication) != "undefined") {
	UnitTestsApplication.registerModule({ label: 'Time-BasedSubtraction Requirements', execute: executeTbSubCalculatedReqServiceTests });
}

if (typeof envianceSdk == "undefined")
	envianceSdk = {};

if (typeof tbSubCalcRequirementsConfig == "undefined")
	tbSubCalcRequirementsConfig = {};

function executeTbSubCalculatedReqServiceTests() {
	module("tbSubCalculated Requirement Service", {
		setup: function () {
			this.originalSessionId = envianceSdk.getSessionId();
			this.originalSystemId = envianceSdk.getSystemId();
			this.password = tbSubCalcRequirementsConfig.password || "1111";
			...
			this.noManageRightsUserName = (paramRequirementsConfig.noManageRightsUserName || "userWPermissionsTbsReq") + qUnitDbSuffix;
			this.responsibleUserIdOrName = "jstestsWPermissions" + qUnitDbSuffix;

			this.type = "TBSRequirement";
			this.newParamReqGuid = "";
			this.createName = "Create TbsReq";
			this.requirementTemplateIdOrName = "Common Requirement Template";
			this.createDescription = "Create TbsReq Description";
			...
			this.existCalcReqName = "Time-Based Sub Req";
			...
			this.buildFullInfo = function (nameStr) {
				return new envianceSdk.requirements.TbSubRequirementInfo(this.type, nameStr, this.generatedFacilityPath, this.activateDate,
					...
					this.periodTime, this.description, this.uom, this.precision, this.calcDescription, this.baseParameterIdOrName, this.isAscending
				)					
			...
			this.buildLightInfo = function (nameStr) {
				return new envianceSdk.requirements.TbSubRequirementInfo(this.type, nameStr, this.generatedFacilityPath, null,
					null, null, this.requirementTemplateIdOrName, null, null,
					null, null, null, null, null, this.baseParameterIdOrName, this.isAscending
				);
			};

			this.buildFullUpdateRequirementInfo = function () {
				return new envianceSdk.requirements.TbSubRequirementInfo(this.type, this.existCalcReqName, this.generatedFacilityPath, this.activateDateUpd,
					this.inactiveDateUpd, this.responsibleUserIdOrName, this.requirementTemplateIdOrName, this.specificCitationUpd,
					this.periodFrequencyUpd, this.periodTimeUpd, this.descriptionUpd, this.uomUpd, this.precisionUpd, this.calcDescriptionUpd, this.baseParameterIdOrNameUpd, this.isAscending
				)					
					.addFrequency(this.occureStartDate, this.occureEndDate, 1)
					.addLimitHistory(this.limitStartDate, this.limitEndDate, 1, 2, ">= LOW, <= HIGH", 3, 4)
					.setRegLimitTaskTemplateAndAsgn(this.taskTemplateIdOrName1, this.accessUser)
			...
			this.buildLightUpdateInfo = function () {
				return new envianceSdk.requirements.TbSubRequirementInfo(this.type, this.existCalcReqName, this.generatedFacilityPath, null,
						null, null, this.requirementTemplateIdOrName, null, null, null, null, null
					);
			};
...
// !!!! responsible user cann't set on TBS Create!!!!!
// 				equal(actual.responsibleUserIdOrName, expected.responsibleUserIdOrName, "Responsible User are equal");
				...
				equal(actual.isAscending, expected.isAscending, "IsAscending are equal");
			};
	...
	asyncTest("Create TBS Requirement - full properties - Happy path", 41, function () {
		var queue = new ActionQueue(this);
		var reqInfo = this.buildFullInfo("Create TBS Requirement - full properties");
	...
	asyncTest("Create TBS Requirement - Set Requirement Template, Name - Happy path", 4, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement- Set Requirement Template, Name");
	...
	asyncTest("Create TBS Requirement under POI ", 4, function () {
		var queue = new ActionQueue(this);
		var caclReqInfo = this.buildLightInfo("Create TBS Requirement under POI");
	...
	asyncTest("Create TBS Requirement under Unit", 4, function () {
		var queue = new ActionQueue(this);
		var caclReqInfo = this.buildLightInfo("Create TBS Requirement under Unit");
	...
	// Get tests
	asyncTest("Get TBS Requirement - Happy path - By Path", 1, function () {
		var queue = new ActionQueue(this);
		queue.enqueue(function (context) {
	...
	asyncTest("Get TBS Requirement - Happy path - By ID", 1, function () {
		var queue = new ActionQueue(this);
		var reqId;
		queue.enqueue(function (context) {
			envianceSdk.requirements.getRequirement(context.generatedCalcReqPath,
	...
	// Update
	asyncTest("Update TBS Requirement - Full update - Happy path", 41, function () {
		var self = this;
		var queue = new ActionQueue(this);
	...
	asyncTest("Update TBS Requirement - change Custom Fields Template - Happy path", 3, function () {
		var self = this;
		var queue = new ActionQueue(this);
	...
	asyncTest("Update TBS Requirement - change Requirement Template - Happy path", 3, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		// TODO : ?
	...
	// Delete tests
	asyncTest("Delete TBS Requirement with all existing properties - Happy Path", 4, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullInfo("Create max tbsCalc for delete");
		var pathName = calcReqInfo.parentIdOrPath + '/' + calcReqInfo.name;
	...
	asyncTest("Delete TBS Requirement with min properties - Happy Path", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create min tbsCalc for delete");
		var pathName = calcReqInfo.parentIdOrPath + '/' + calcReqInfo.name;
	...
	asyncTest("Delete TBS Requirement by path - Happy Path", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqName = "Create tbsCalc for delete by name";
	...
	// Fault tests
	asyncTest("Create TBS Requirement - without requirement template", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement - without requirement template");
	...
	asyncTest("Create TBS Requirement - under Division", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement - under Division");
	...
	asyncTest("Create TBS Requirement - with invalid Requirement Template ID", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement - invalid ReqTemplateID");
	...
	asyncTest("Create TBS Requirement -  with invalid Custom Field Template ID", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement - invalid ReqTemplateID");
	...
	asyncTest("Create TBS Requirement -  with already exisiting name", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement - with empty name", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement - with empty name");
		calcReqInfo.name = "";
	...
	asyncTest("Create TBS Requirement - Inactive Date is less than Active Date", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement - Responsible User (non -existing user)", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-add Expected Frequency History-fill wrong data(endDate > startDate)", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-add Expected Frequency History-fill wrong data(overlap period)", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-add Limits History History-End Date is less or equal to Begin Date", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-add Limits History-add Limits Histories with time periods that overlap", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-add Limits History-Comparison '> LOW', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-add Limits History-Comparison '< HIGH', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Limits History-leave both Lows empty 2");
	...
	asyncTest("Create TBS Requirement-add Limits History-Comparison '> LOW < HIGH', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Limits History-leave both Lows empty 2");
	...
	asyncTest("Create TBS Requirement-add Limits History-Comparison '> LOW < HIGH', leave both Highs empty", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-Task for Regulatory Limit-not add Limits History then add Regulatory Task Template", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement-Task for Internal Limit-add Limits History without Internal Limit then add Internal Task Template", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement -  Task for Regulatory Limit - add Limits History without Regulatory Limit then add Regulatory Task Template", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement -  Task for Regulatory Limit - add Limits History, add Internal Task Template, not add Assignor", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement -  Task for Regulatory Limit - add Limits History, add Internal Task Template, not add Assignee", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("add RegulatoryTaskTemplate wout Assignor");
		calcReqInfo.addLimitHistory(this.limitStartDate, this.limitEndDate, 1, "", ">= LOW", 1, "");
	...
	asyncTest("Create TBS Requirement -  Task for Internal Limit - add Limits History, add Internal Task Template, not add Assignor", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement -  Task for Internal Limit - add Limits History, add Internal Task Template, not add Assignee", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("add InternalTaskTemplate wout Assignor");
		calcReqInfo.addLimitHistory(this.limitStartDate, this.limitEndDate, 1, "", ">= LOW", 1, "");
	...
	asyncTest("Create TBS Requirement - Send data warnings to user and NOT specify 'Email', 'Inbox'", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement - Send data warnings to group and NOT specify 'Email', 'Inbox'", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Update TBS Requirement - with empty name", 1, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		calcReqInfo.name = "";
	...
	asyncTest("Update TBS Requirement - Inactive Date is less than Active Date", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement  -  Responsible User (non -existing user)", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Expected Frequency History - End Date is less or equal to Begin Date", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Expected Frequency History - enter Occurrences ('0')", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Expected Frequency History - enter Occurrences ('1441')", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Expected Frequency Histories with time periods that overlap", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		calcReqInfo.frequencies = [];
	...
	asyncTest("Update TBS Requirement - add Limits History  - End Date is less or equal to Begin Date", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Limits Histories with time periods that overlap", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Limits Histories - Comparison '> LOW', leave both Lows empty", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Limits Histories - Comparison '< HIGH', leave both Highs empty", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Limits Histories - Comparison '<= HIGH', leave both Lows empty", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		calcReqInfo.addLimitHistory(envianceSdk.IsoDate.parse("2010-02-02T00:00"), envianceSdk.IsoDate.parse("2010-01-02T00:00"), 1, "", "<= HIGH", 2, "");
	...
	asyncTest("Update TBS Requirement - add Limits Histories - Comparison '> LOW, < HIGH', leave Lows and Highs empty", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Limits Histories - Comparison '> LOW, < HIGH',  Internal High is less or equal than Internal Low", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement - add Limits Histories - Comparison '> LOW, < HIGH',  Regulatory High is less or equal than Regulatory Low", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update TBS Requirement -  Task for Internal Limit - Limits History NOT added then add Internal Task Template", 3, function () {
		var queue = new ActionQueue(this);

		var createcalcReqInfo = this.buildFullInfo("Update TBS Requirement -  Task for Internal Limit");
	...
	asyncTest("Update TBS Requirement -  Task for Regulatory Limit - add Limits History without Regulatory Limit then add Regulatory Task Template", 3, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create TBS Requirement without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		var calcReqInfo = this.buildLightInfo("Create TBS Requirement - without appropriate permissions");
		queue.enqueue(function (context) {
			envianceSdk.requirements.createRequirement(calcReqInfo,
				context.successHandler,
				function (response) {
	...
	asyncTest("Update TBS Requirement under CO without appropriate permissions", 2, function () {
		var self = this;
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Get TBS Requirement under CO without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		queue.enqueue(function (context) {
			envianceSdk.requirements.getRequirement(context.generatedCalcReqPath,
	...
	asyncTest("Delete TBS Requirement  under CO without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		queue.enqueue(function (context) {
...
if (typeof (UnitTestsApplication) == "undefined") {	
	executeTbSubCalculatedReqServiceTests();
}