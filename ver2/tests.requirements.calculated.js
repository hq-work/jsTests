if (typeof(UnitTestsApplication) != "undefined") {
	UnitTestsApplication.registerModule({ label: 'Calculated Requirements', execute: executeCalculatedRequirementServiceTests });
}

if (typeof envianceSdk == "undefined")
	envianceSdk = {};

if (typeof calcRequirementsConfig == "undefined")
	calcRequirementsConfig = {};

function executeCalculatedRequirementServiceTests() {
	module("Calculated Requirement Service", {
		setup: function () {
			this.originalSessionId = envianceSdk.getSessionId();
			this.originalSystemId = envianceSdk.getSystemId();
			this.password = calcRequirementsConfig.password || "1111";
			...
			this.noManageRightsUserName = (paramRequirementsConfig.noManageRightsUserName || "userWPermissionsCalcReq") + qUnitDbSuffix;
			this.responsibleUserIdOrName = "jstestsWPermissions" + qUnitDbSuffix;
		
			this.type = "CalcRequirement";
			this.newCalcReqGuid = "";
			this.createName = "Create CalcReq";
			this.requirementTemplateIdOrName = "Common Requirement Template";
			this.description = "Create CalcReq Description";
			...
			this.existCalcReqName = "Calculated Requirement";
			...
			this.formulaStartDate1 = envianceSdk.IsoDate.parse("2012-01-01T00:00");
			this.formulaEndDate1 = envianceSdk.IsoDate.parse("2014-01-01T00:00");
			this.formulaStartDate2 = envianceSdk.IsoDate.parse("2014-01-01T00:00");
			this.formulaEndDate2 = envianceSdk.IsoDate.parse("2015-01-01T00:00");
			this.exceptionDivideByZero = 1;
			this.exceptionOverflow = 2;
			this.exceptionOther = 3;			
			// task templates
			...
			this.buildFullInfo = function (nameStr) {
				return new envianceSdk.requirements.CalcRequirementInfo(this.type, nameStr, this.generatedFacilityPath, this.activateDate,
					...
					.addFormulaHistory(this.formulaStartDate1, this.formulaEndDate1, "[Parameter Requirement for Calc]+212", 12, 22, 32)
			...
			this.buildEmptyInfo = function (nameStr) {
				return new envianceSdk.requirements.CalcRequirementInfo(this.type, nameStr, this.generatedFacilityPath,
			...
			this.buildFullUpdateRequirementInfo = function () {
				return new envianceSdk.requirements.CalcRequirementInfo(this.type, this.existCalcReqName, this.generatedFacilityPath, this.activateDateUpd,
					...
					.addFormulaHistory(this.formulaStartDate1, this.formulaEndDate1, "[System Variable for Calc]+1", this.exceptionDivideByZero, this.exceptionOverflow, this.exceptionOther)
					.addFormulaHistory(this.formulaStartDate2, this.formulaEndDate2, "[System Variable for Calc]+2", this.exceptionDivideByZero, this.exceptionOverflow, this.exceptionOther)
					.addRequirementsAliasMap("[Parameter Requirement for Calc]", "Division For Requirements Test\\Facility For Requirements Test\\Parameter Requirement for Calc")
					.addRequirementsAliasMap("[System Variable for Calc]", "Division For Requirements Test\\Facility For Requirements Test\\System Variable for Calc")
					.addRequirementsAliasMap("[Autoparameter Requirement for Calc]", "Division For Requirements Test\\Facility For Requirements Test\\Autoparameter Requirement for Calc")
					.addFrequency(this.occureStartDate, this.occureEndDate, 1)
			...
			this.buildLightUpdateInfo = function () {
				return new envianceSdk.requirements.CalculatedRequirementInfo(this.type, this.existCalcReqName, this.generatedFacilityPath, null,
					null, null, this.requirementTemplateIdOrName, null, null, null, null, null, null, null
				).addFormulaHistory(this.occureStartDate, this.occureEndDate, "1+1", "1", "2", "3");
			};
			// compare
			this.fullCompareRequirementInfo = function (actual, expected) {
				...
				deepEqual(actual.formulaHistory, expected.formulaHistory, "Formula history are equal");
			};
	...
	asyncTest("Create Calculated Requirement - full properties - Happy path", 39, function () {		
		var queue = new ActionQueue(this);
		var reqInfo = this.buildFullInfo("Create Calculated Requirement - full properties");
	...
	asyncTest("Create Calculated Requirement - Set Requirement Template, Name - Happy path", 4, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create CalculatedReq - Set Requirement Template, Name");
	...
	asyncTest("Create Calculated Requirement under POI ", 4, function () {
		var queue = new ActionQueue(this);
		var caclReqInfo = this.buildLightInfo("Create Calculated Requirement under POI");
	...
	asyncTest("Create Calculated Requirement under Unit", 4, function () {
		var queue = new ActionQueue(this);
		var caclReqInfo = this.buildLightInfo("Create Calculated Requirement under Unit");
	...
	asyncTest("Create Calculated Requirement - with 3 valid Calculation Definitions - Happy path", 3, function () {
		var queue = new ActionQueue(this);
		var reqInfo = this.buildFullInfo("Create Calculated Requirement - full properties");
		var pathName = reqInfo.parentIdOrPath + '/' + reqInfo.name;
		reqInfo.formulaHistory = [];		
		reqInfo.addFormulaHistory(envianceSdk.IsoDate.parse("2010-01-01T00:00:00"), envianceSdk.IsoDate.parse("2011-01-01T00:00:00"), "1+[Parameter Requirement for Calc]", 1, 2, 3);
		reqInfo.addFormulaHistory(envianceSdk.IsoDate.parse("2012-01-01T00:00:00"), envianceSdk.IsoDate.parse("2013-01-01T00:00:00"), "2+[System Variable for Calc]", 1, 2, 3);
		reqInfo.addFormulaHistory(envianceSdk.IsoDate.parse("2014-01-01T00:00:00"), envianceSdk.IsoDate.parse("2015-01-01T00:00:00"), "3+[Autoparameter Requirement for Calc]", 1, 2, 3);
		queue.enqueue(function (context) {
			envianceSdk.requirements.createRequirement(reqInfo,
				function (response) {
					equal(response.metadata.statusCode, 200, "Status code OK");
		...
		queue.enqueue(function (context) {
			envianceSdk.requirements.getRequirement(pathName,
				function (response) {
					equal(response.metadata.statusCode, 200, "Status code OK");
					deepEqual(response.result.formulaHistory, reqInfo.formulaHistory, "Formula History are equal");
					start();
				}, context.errorHandler);
		});
		queue.executeNext();
	...
	asyncTest("Create Calculated Requirement - with CD: valid Begin and empty End Date - Happy path", 8, function () {
		var queue = new ActionQueue(this);
		var reqInfo = this.buildFullInfo("Create Calculated Requirement - full properties");
		var pathName = reqInfo.parentIdOrPath + '/' + reqInfo.name;
		reqInfo.formulaHistory = [];
		reqInfo.addFormulaHistory(envianceSdk.IsoDate.parse("2015-12-01T00:00:00"), null, "[Parameter Requirement for Calc]+212", 1, 2, 3);
		...
		queue.enqueue(function (context) {
			envianceSdk.requirements.getRequirement(pathName,
				function (response) {
					equal(response.metadata.statusCode, 200, "Status code OK");
					equal(response.result.formulaHistory.length, 1, "history item length is 1 OK");
					if (response.result.formulaHistory.length == 1) {
						deepEqual(response.result.formulaHistory[0].beginDate, reqInfo.formulaHistory[0].beginDate, "beginDate are equal");
						equal(response.result.formulaHistory[0].script, reqInfo.formulaHistory[0].script, "script are equal");
						equal(response.result.formulaHistory[0].exceptionOther, reqInfo.formulaHistory[0].exceptionOther, "ex other are equal");
						equal(response.result.formulaHistory[0].exceptionOverflow, reqInfo.formulaHistory[0].exceptionOverflow, "ex overflow are equal");
						equal(response.result.formulaHistory[0].exceptionDivideByZero, reqInfo.formulaHistory[0].exceptionDivideByZero, "ex divideByZero are equal");
					}
	...
	// Update
	asyncTest("Update Calculated Requirement - Full update - Happy path", 39, function () {
		var queue = new ActionQueue(this);
		var caclReqInfo = this.buildFullUpdateRequirementInfo();		

		queue.enqueue(function (context) {
			envianceSdk.requirements.updateRequirement(context.generatedCalcReqPath, caclReqInfo,
				function (response) {
	...
	asyncTest("Update Calculated Requirement - change Custom Fields Template - Happy path", 3, function () {
		var queue = new ActionQueue(this);
		...
		queue.enqueue(function (context) {
			envianceSdk.requirements.updateRequirement(context.generatedCalcReqPath, calcReqInfo,
				function (response) {
					equal(response.metadata.statusCode, 200, "Status code is correct.");
					queue.executeNext();
				}, context.errorHandler);
	...
	asyncTest("Update Calculated Requirement - change Requirement Template - Happy path", 3, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		// TODO : ?
	...
	asyncTest("Delete Calculated Requirement with all existing properties - Happy Path", 4, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullInfo("Create max CalculatedReq for delete");
		var pathName = calcReqInfo.parentIdOrPath + '/' + calcReqInfo.name;
	...
	asyncTest("Delete Calculated Requirement with min properties - Happy Path", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create min CalculatedReq for delete");
		var pathName = calcReqInfo.parentIdOrPath + '/' + calcReqInfo.name;
	...
	asyncTest("Delete Calculated Requirement by path - Happy Path", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqName = "Create CalculatedReq for delete by name";
	...
	// Fault tests
	asyncTest("Create Calculated Requirement - without requirement template", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create Calculated Requirement - without requirement template");
	...
	asyncTest("Create Calculated Requirement - under Division", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create Calculated Requirement - under Division");
	...
	asyncTest("Create Calculated Requirement - with invalid Requirement Template ID", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create Calculated Requirement - invalid ReqTemplateID");
	...
	asyncTest("Create Calculated Requirement -  with invalid Custom Field Template ID", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create Calculated Requirement - invalid ReqTemplateID");
	...
	asyncTest("Create Calculated Requirement -  with already exisiting name", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement - with empty name", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("Create Calculated Requirement - with empty name");
		calcReqInfo.name = "";
	...
	asyncTest("Create Calculated Requirement - Inactive Date is less than Active Date", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement - Responsible User (non -existing user)", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement - Formula History End Date is less or equal to Begin Date", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildEmptyInfo("Formula History End Date is less or equal to Begin Date");
		calcReqInfo.addFormulaHistory(envianceSdk.IsoDate.parse("2015-04-04T00:00"), envianceSdk.IsoDate.parse("2015-03-03T00:00"), "[Parameter Requirement for Calc]", "1", "2", "3");
	...
	asyncTest("Create Calculated Requirement - Formula History Script is empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullInfo("Formula History Script is empty")
			.addFormulaHistory(envianceSdk.IsoDate.parse("2015-03-03T00:00"), envianceSdk.IsoDate.parse("2015-04-04T00:00"), "")
			.addRequirementsAliasMap("[Parameter Requirement for Calc]", "Division For Requirements Test\\Facility For Requirements Test\\Parameter Requirement for Calc");
		queue.enqueue(function (context) {
			envianceSdk.requirements.createRequirement(calcReqInfo,
				context.successHandler,
	...
	asyncTest("Create Calculated Requirement - Formula History Invalid Script ", 2, function () {
		var queue = new ActionQueue(this);		
		var calcReqInfo = this.buildFullInfo("Formula History Script is empty")
			.addFormulaHistory(envianceSdk.IsoDate.parse("2015-03-03T00:00"), envianceSdk.IsoDate.parse("2015-04-04T00:00"), "1+")
			.addRequirementsAliasMap("[Parameter Requirement for Calc]", "Division For Requirements Test\\Facility For Requirements Test\\Parameter Requirement for Calc");
		queue.enqueue(function (context) {
			envianceSdk.requirements.createRequirement(calcReqInfo,
				context.successHandler,
	...
	asyncTest("Create Calculated Requirement - add Formula History Scripts with time periods that overlap ", 2, function () {
		var queue = new ActionQueue(this);		
		var calcReqInfo = this.buildFullInfo("Formula History Script is empty")
			.addFormulaHistory(envianceSdk.IsoDate.parse("2015-03-03T00:00"), envianceSdk.IsoDate.parse("2015-06-06T00:00"), "[Parameter Requirement for Calc]")
			.addFormulaHistory(envianceSdk.IsoDate.parse("2015-02-02T00:00"), envianceSdk.IsoDate.parse("2015-05-05T00:00"), "[Parameter Requirement for Calc]")
			.addRequirementsAliasMap("[Parameter Requirement for Calc]", "Division For Requirements Test\\Facility For Requirements Test\\Parameter Requirement for Calc");
		queue.enqueue(function (context) {
			envianceSdk.requirements.createRequirement(calcReqInfo,
				context.successHandler,
	...
	asyncTest("Create Calculated Requirement-add Expected Frequency History-fill wrong data(endDate > startDate)", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-add Expected Frequency History-fill wrong data(overlap period)", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-add Limits History History-End Date is less or equal to Begin Date", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-add Limits History-add Limits Histories with time periods that overlap", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-add Limits History-Comparison '> LOW', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-add Limits History-Comparison '< HIGH', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullInfo("Limits History-leave both Lows empty 2");
	...
	asyncTest("Create Calculated Requirement-add Limits History-Comparison '> LOW < HIGH', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullInfo("Limits History-leave both Lows empty 2");
	...
	asyncTest("Create Calculated Requirement-add Limits History-Comparison '> LOW < HIGH', leave both Highs empty", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-Task for Regulatory Limit-not add Limits History then add Regulatory Task Template", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement-Task for Internal Limit-add Limits History without Internal Limit then add Internal Task Template", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement -  Task for Regulatory Limit - add Limits History without Regulatory Limit then add Regulatory Task Template", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement -  Task for Regulatory Limit - add Limits History, add Internal Task Template, not add Assignor", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement -  Task for Regulatory Limit - add Limits History, add Internal Task Template, not add Assignee", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("add RegulatoryTaskTemplate wout Assignor");
		calcReqInfo.addLimitHistory(this.limitStartDate, this.limitEndDate, 1, "", ">= LOW", 1, "");
	...
	asyncTest("Create Calculated Requirement -  Task for Internal Limit - add Limits History, add Internal Task Template, not add Assignor", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement -  Task for Internal Limit - add Limits History, add Internal Task Template, not add Assignee", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildLightInfo("add InternalTaskTemplate wout Assignor");
		calcReqInfo.addLimitHistory(this.limitStartDate, this.limitEndDate, 1, "", ">= LOW", 1, "");
	...
	asyncTest("Create Calculated Requirement - Send data warnings to user and NOT specify 'Email', 'Inbox'", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement - Send data warnings to group and NOT specify 'Email', 'Inbox'", 2, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Update Calculated Requirement - with empty name", 1, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		calcReqInfo.name = "";
		queue.enqueue(function (context) {
	...
	asyncTest("Update Calculated Requirement - Inactive Date is less than Active Date", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement  -  Responsible User (non -existing user)", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Expected Frequency History - End Date is less or equal to Begin Date", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Expected Frequency History - enter Occurrences ('0')", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Expected Frequency History - enter Occurrences ('1441')", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Expected Frequency Histories with time periods that overlap", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		calcReqInfo.frequencies = [];
	...
	asyncTest("Update Calculated Requirement - add Limits History  - End Date is less or equal to Begin Date", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Limits Histories with time periods that overlap", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Limits Histories - Comparison '> LOW', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Limits Histories - Comparison '< HIGH', leave both Highs empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Limits Histories - Comparison '<= HIGH', leave both Lows empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		calcReqInfo.addLimitHistory(envianceSdk.IsoDate.parse("2010-02-02T00:00"), envianceSdk.IsoDate.parse("2010-01-02T00:00"), 1, "", "<= HIGH", 2, "");
		queue.enqueue(function (context) {
	...
	asyncTest("Update Calculated Requirement - add Limits Histories - Comparison '> LOW, < HIGH', leave Lows and Highs empty", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Limits Histories - Comparison '> LOW, < HIGH',  Internal High is less or equal than Internal Low", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement - add Limits Histories - Comparison '> LOW, < HIGH',  Regulatory High is less or equal than Regulatory Low", 2, function () {
		var queue = new ActionQueue(this);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
	...
	asyncTest("Update Calculated Requirement -  Task for Internal Limit - Limits History NOT added then add Internal Task Template", 3, function () {
		var queue = new ActionQueue(this);

		var createcalcReqInfo = this.buildFullInfo("Update Calculated Requirement -  Task for Internal Limit");
	...
	asyncTest("Update Calculated Requirement -  Task for Regulatory Limit - add Limits History without Regulatory Limit then add Regulatory Task Template", 3, function () {
		var queue = new ActionQueue(this);
	...
	asyncTest("Create Calculated Requirement without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		var calcReqInfo = this.buildLightInfo("Create Calculated Requirement - without appropriate permissions");
		queue.enqueue(function (context) {
			envianceSdk.requirements.createRequirement(calcReqInfo,
				context.successHandler,
				function (response) {
	...
	asyncTest("Update Calculated Requirement under CO without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		var calcReqInfo = this.buildFullUpdateRequirementInfo();
		queue.enqueue(function (context) {
	...
	asyncTest("Get Calculated Requirement under CO without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		queue.enqueue(function (context) {
			envianceSdk.requirements.getRequirement(context.generatedCalcReqPath,
	...
	asyncTest("Delete Calculated Requirement  under CO without appropriate permissions", 2, function () {
		var queue = new ActionQueue(this);
		this._authenticate(queue, this.noManageRightsUserName);
		queue.enqueue(function (context) {
